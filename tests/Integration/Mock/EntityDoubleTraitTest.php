...
class EntityDoubleTraitTest extends TestCase
{
    ...
    public function testScalarFieldAccess(): void
    {
        ...
        // PHPUnit mocks don't support __get, so use get() method.
    ...
    {
        // For PHPUnit: use only EntityChangedInterface (which extends EntityInterface)
        // and configure field-related methods via overrides if needed.
        $entity = $this->createEntityDouble([
            'entity_type' => 'node',
            'bundle' => 'article',
            'interfaces' => [
